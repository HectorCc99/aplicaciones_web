...
<html lang="en">
    ...
    <body>
        ...
        <script src="js/horarios.js"></script> <!--se ocupo para llamar a la función de semestres-->
        <script src="js/espacios.js"></script> <!--se ocupo para llamar a la función de semestres-->
    </body>
</html>